...
#SBATCH -A e3sm_g
#SBATCH -q regular
#SBATCH -C gpu&hbm40g          # measured: 21,155 MiB of 40,960, and 9.4% slower than hbm80g
#SBATCH -J fme-sep26-atm
#SBATCH --nodes=4
...
if [ -n "${RUNID:-}" ]; then
    export FME_OUTPUT_DIR=${CAMPAIGN_ROOT:-${PSCRATCH}/sep26}/${RUNID}
